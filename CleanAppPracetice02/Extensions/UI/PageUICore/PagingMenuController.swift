...
internal let TagMenuScroll = 1001       //Oa Add
internal let TagPageViewScroll = 1002   //Oa Add
...
open class PagingMenuController: UIViewController {
    public fileprivate(set) var menuView: MenuView? {
        didSet {
            ...
            menuView.tag = TagMenuScroll //Oa Add
    ...
    public fileprivate(set) var pagingViewController: PagingViewController? {
        didSet {
            ...
            pagingViewController.contentScrollView.tag = TagPageViewScroll //Oa Add
    ...
    fileprivate func layoutPagingViewController() {
        ...
        case .all(let menuOptions, _):
            ...
            case .topInView:
                ...
                NSLayoutConstraint.activate([
                    menuView.bottomAnchor.constraint(equalTo: pagingViewController.view.topAnchor, constant:menuOptions.height),
                    pagingViewController.view.bottomAnchor.constraint(equalTo: view.bottomAnchor),
                    ])
...
extension PagingMenuController: UIScrollViewDelegate {
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        if scrollView.tag == TagPageViewScroll {
